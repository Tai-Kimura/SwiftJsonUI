...
extension JSON: Swift.RawRepresentable {
    ...
    public func rawString(_ options: [writingOptionsKeys: Any]) -> String? {
        ...
        do {
            ...
            Logger.debug("Could not serialize object to JSON because:", error.localizedDescription)
            return nil
        }
    }
...
extension JSON {
    ...
    public var cgFloat: CGFloat? {
        get {
            return self.number?.floatValue == nil ? nil : CGFloat(self.number!.floatValue)
        }
        set {
            if newValue != nil {
                self.object = NSNumber(value: Float(newValue!))
            } else {
                self.object = NSNull()
            }
        }
    ...
    public var cgFloatValue: CGFloat {
        get {
            return CGFloat(self.numberValue.floatValue)
        }
        set {
            self.object = NSNumber(value: Float(newValue))
        }
