...
class BindingDestroyer < Destroyer
  ...
  def destroy(view_name)
    ...
    safe_pbxproj_operation([binding_file_name], files_to_remove) do
      remove_entries_from_project_content([binding_file_name])
...
if __FILE__ == $0
  ...
  begin
    ...
    destroyer = BindingDestroyer.new(project_file_path)
