...
public struct EditTextAttributes {
    ...
    private static func parseAutocapitalizationType(_ raw: Any?) -> AttrEnum<AutocapitalizationType>? {
        ...
        AttrCodegenWarnings.emit("EditText.autocapitalizationType: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
    ...
    private static func parseAutocorrectionType(_ raw: Any?) -> AttrEnum<AutocorrectionType>? {
        ...
        AttrCodegenWarnings.emit("EditText.autocorrectionType: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
    ...
    private static func parseBorderStyle(_ raw: Any?) -> AttrEnum<BorderStyle>? {
        ...
        AttrCodegenWarnings.emit("EditText.borderStyle: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
    ...
    private static func parseContentType(_ raw: Any?) -> AttrEnum<ContentType>? {
        ...
        AttrCodegenWarnings.emit("EditText.contentType: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
    ...
    private static func parseInput(_ raw: Any?) -> AttrEnum<Input>? {
        ...
        AttrCodegenWarnings.emit("EditText.input: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
    ...
    private static func parseInputType(_ raw: Any?) -> AttrEnum<InputType>? {
        ...
        AttrCodegenWarnings.emit("EditText.inputType: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
    ...
    private static func parseReturnKeyType(_ raw: Any?) -> AttrEnum<ReturnKeyType>? {
        ...
        AttrCodegenWarnings.emit("EditText.returnKeyType: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
    ...
    private static func parseTextAlign(_ raw: Any?) -> AttrEnum<TextAlign>? {
        ...
        AttrCodegenWarnings.emit("EditText.textAlign: unknown enum value '\(raw)'")
        return .unknown(raw)
    }
}
