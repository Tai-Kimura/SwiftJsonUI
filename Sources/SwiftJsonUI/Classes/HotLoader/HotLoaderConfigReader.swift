...
public class HotLoaderConfigReader {
    public static func getHotLoaderConfig() -> (ip: String, port: Int) {
        ...
        if let url = Bundle.main.url(forResource: "hotloader_config", withExtension: "json"),
        ...
        let configPath = (documentsPath as NSString).appendingPathComponent("hotloader_config.json")
