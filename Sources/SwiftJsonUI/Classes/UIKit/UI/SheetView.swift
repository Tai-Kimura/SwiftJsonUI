...
open class SheetView: NSObject, UIPickerViewDelegate, UIPickerViewDataSource, UIGestureRecognizerDelegate {
    ...
    fileprivate var _datePickerTopConstraint: NSLayoutConstraint!
    ...
    public func createPickerView() -> UIView {
        ...
        _selectBtn.accessibilityIdentifier = "sjui_x7q_done"
        ...
        _backBtn.accessibilityIdentifier = "sjui_x7q_back"
        ...
        _datePickerTopConstraint = _datePicker.topAnchor.constraint(equalTo: customView.topAnchor, constant: 20.0)
    ...
    public func showPicker(_ selectRows:[Int], withDataSource datasource:[[Any]], forItem itemNames: [String], inView mainView: UIView, canBack: Bool = false, duration: TimeInterval = 0.3, completion: ((Bool) -> Void)? = nil) {
        ...
        // Encode items for test automation (enables index-based selection)
        if let firstComponent = datasource.first {
            let itemStrings = firstComponent.compactMap { $0 as? String }
            _pickerView.accessibilityValue = itemStrings.joined(separator: "|||")
        }
        self.show(mainView, duration: duration, completion: completion)
    }
    public func showDatePicker(mode: UIDatePicker.Mode, date: Date, inView mainView: UIView, minimumDate: Date? = nil, maximumDate: Date? = nil, minuteInterval: Int? = nil, duration: TimeInterval = 0.3, canBack: Bool = false, completion: ((Bool) -> Void)? = nil, locale: Locale? = nil) {
        if #available(iOS 14.0, *) {
            _customView.frame.size.height = SheetView.defaultHeight
            _datePickerTopConstraint.constant = 20.0
        }
    ...
    @available(iOS 14.0, *)
    public func showDatePicker(mode: UIDatePicker.Mode, style: UIDatePickerStyle, date: Date, inView mainView: UIView, minimumDate: Date? = nil, maximumDate: Date? = nil, minuteInterval: Int? = nil, duration: TimeInterval = 0.3, canBack: Bool = false, completion: ((Bool) -> Void)? = nil, locale: Locale? = nil) {
            switch style {
            case .automatic:
                _customView.frame.size.height = SheetView.defaultHeight
                _datePickerTopConstraint.constant = 20.0
            ...
            case .inline:
                ...
                _datePickerTopConstraint.constant = 41.0
            @unknown default:
                _customView.frame.size.height = SheetView.defaultHeight
                _datePickerTopConstraint.constant = 20.0
            }
    ...
    private func prepareDatePickerForShow(mode: UIDatePicker.Mode, date: Date, inView mainView: UIView, minimumDate: Date? = nil, maximumDate: Date? = nil, minuteInterval: Int? = nil, canBack: Bool = false, locale: Locale? = nil) {
        ...
        self._datePicker.locale = effectiveLocale
    ...
    public func show(_ mainView: UIView, duration: TimeInterval = 0.3, completion: ((Bool) -> Void)? = nil) {
        ...
        DispatchQueue.main.async(execute: {
            self._view.frame = mainView.bounds
