    ...
    module Generators
      class ConverterGenerator
        ...
        def generate
          ...
          @logger.info "Swift file created at: #{extension_dir}/#{to_camel_case(@name)}.swift"
        end
        ...
        def create_swift_file
          ...
          swift_file_path = File.join(swift_dir, "#{to_camel_case(@name)}.swift")
        ...
        def swift_template
          ...
          parameters = generate_swift_parameters
        ...
        def generate_swift_properties
          ...
          if @options[:is_container] != false
            lines << "    let content: Content" if @options[:is_container] == true
            lines << "    let content: Content?" if @options[:is_container].nil?
          end
        ...
        def generate_swift_content
          ...
          elsif @options[:is_container].nil?
